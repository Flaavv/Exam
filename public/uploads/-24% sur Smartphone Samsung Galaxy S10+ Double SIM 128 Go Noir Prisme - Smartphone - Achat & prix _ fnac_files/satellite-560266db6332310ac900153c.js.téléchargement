// 18/12/2019 : Ligne126 - Suppression de l'écriture de l'evar66 dans le cookie s_ev66. Cookie trop volimineux. 

// Used by non-react pages (datalayer is inlined in a script tag with s.* = ...) Mise à jour publiéé le 14/11/2019 à 16h16
...
s.eVar96=s.getQueryParam('fnacbot');
  ...
  //Les les lignes ci-dessous ont été commentées à cause du problème du gros volume du cookie s_ev66
	//if(!s.eVar66)
